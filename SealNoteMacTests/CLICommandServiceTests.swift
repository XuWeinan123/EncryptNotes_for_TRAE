...
final class CLISettingsTests: XCTestCase {
    func testEncryptedCLIAccessIsRevokedWhenSettingsReload() {
        ...
        XCTAssertFalse(enabledReload.cliEncryptedAccessEnabled)
        XCTAssertFalse(defaults.bool(forKey: "SNCLIEncryptedAccessEnabled"))
